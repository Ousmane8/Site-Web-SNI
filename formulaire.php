...
$destinataire = 'snitransport77@gmail.com';
...
else
{
    ...
    if (($nom != '') && ($email != '') && ($objet != '') && ($message != ''))
    {
        ...
        {
            echo '<p>'.$message_envoye.'<a href="index.html#contact">Retour</a></p>';
        }
        else
        {
            echo '<p>'.$message_non_envoye.'<a href="index.html#contact">Retour au formulaire</a></p>';
        };
    }
    else
    {
